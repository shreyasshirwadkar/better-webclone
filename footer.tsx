          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <h3 className="font-semibold">
                <span className="text-[#008060]">Better</span> <span className="text-gray-400">Mortgage</span>
              </h3>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">
                <span className="text-[#008060]">Better</span> <span className="text-gray-400">Real Estate</span>
              </h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">
                <span className="text-[#008060]">Better</span> <span className="text-gray-400">Cover</span>
              </h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">
                <span className="text-[#008060]">Better</span> <span className="text-gray-400">Inspect</span>
              </h3>
              <p className="text-gray-600 text-sm">
